    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_person_female_display_name', models.CharField(blank=True, default='', max_length=100)),
                ('to_person_male_display_name', models.CharField(blank=True, default='', max_length=100)),
                ('to_person_female_display_name', models.CharField(blank=True, default='', max_length=100)),
            ],
            options={
                'ordering': ('-datetime_updated',),
                'abstract': False,
